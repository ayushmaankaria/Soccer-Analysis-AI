...
class Tracker:
    ...
    def draw_ellipse(self, frame, bbox, color, track_id=None):
        ...
        cv2.ellipse(frame, center, axes, angle, start_angle, end_angle, color, thickness, line_type)
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        #get num of times each team had ball control
